...
let $transferInforHongBao="/youhui/transferInforHongBao.php"; //红包
...
let $canGetPt8CouponCheck ='/youhui/canGetPt8CouponCheck.php'; //确认体验金
let $youhuiDisplay ='/youhui/youhuiDisplay.php'; //查询体验金
